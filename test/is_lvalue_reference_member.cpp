...
void assert_lvalue_qualified() {
    ...
    CT_ASSERT(ct::is_lvalue_reference_member<T&>());
    CT_ASSERT(ct::is_lvalue_reference_member<T &&>());
    CT_ASSERT(ct::is_lvalue_reference_member<T const>());
    CT_ASSERT(ct::is_lvalue_reference_member<T const &>());
    CT_ASSERT(ct::is_lvalue_reference_member<T const &&>());
    CT_ASSERT(ct::is_lvalue_reference_member<T volatile>());
    CT_ASSERT(ct::is_lvalue_reference_member<T volatile &>());
    CT_ASSERT(ct::is_lvalue_reference_member<T volatile &&>());
    CT_ASSERT(ct::is_lvalue_reference_member<T const volatile &>());
    CT_ASSERT(ct::is_lvalue_reference_member<T const volatile &&>());

    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T&>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T &&>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T const>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T const &>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T const &&>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T volatile>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T volatile &>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T volatile &&>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T const volatile &>()))::value);
    CT_ASSERT(decltype(ct::is_lvalue_reference_member(std::declval<T const volatile &&>()))::value);
}
