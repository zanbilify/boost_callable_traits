...
void assert_const_qualified() {
    ...
    CT_ASSERT(ct::is_const_member<T&>());
    CT_ASSERT(ct::is_const_member<T &&>());
    CT_ASSERT(ct::is_const_member<T const>());
    CT_ASSERT(ct::is_const_member<T const &>());
    CT_ASSERT(ct::is_const_member<T const &&>());
    CT_ASSERT(ct::is_const_member<T volatile>());
    CT_ASSERT(ct::is_const_member<T volatile &>());
    CT_ASSERT(ct::is_const_member<T volatile &&>());
    CT_ASSERT(ct::is_const_member<T const volatile &>());
    CT_ASSERT(ct::is_const_member<T const volatile &&>());

    CT_ASSERT(decltype(ct::is_const_member(std::declval<T>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T&>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T &&>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T const>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T const &>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T const &&>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T volatile>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T volatile &>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T volatile &&>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T const volatile &>()))::value);
    CT_ASSERT(decltype(ct::is_const_member(std::declval<T const volatile &&>()))::value);
}
...
int main() {
...

    {
        ...
        CT_ASSERT(!ct::is_const_member<r>());
        CT_ASSERT(ct::is_const_member<c>());
        CT_ASSERT(ct::is_const_member<cl>());
        CT_ASSERT(ct::is_const_member<cr>());
        CT_ASSERT(!ct::is_const_member<v>());
        CT_ASSERT(!ct::is_const_member<vl>());
        CT_ASSERT(!ct::is_const_member<vr>());
        CT_ASSERT(ct::is_const_member<cv>());
        CT_ASSERT(ct::is_const_member<cvl>());
