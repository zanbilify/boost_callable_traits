...
int main() {

    {
        ...
        CT_ASSERT(std::is_same<c,   ct::add_function_const<c>>{});
        CT_ASSERT(std::is_same<cl,  ct::add_function_const<l>>{});
        CT_ASSERT(std::is_same<cl,  ct::add_function_const<cl>>{});
        CT_ASSERT(std::is_same<cr,  ct::add_function_const<r>>{});
        CT_ASSERT(std::is_same<cr,  ct::add_function_const<cr>>{});
        CT_ASSERT(std::is_same<cv,  ct::add_function_const<v>>{});
        CT_ASSERT(std::is_same<cv,  ct::add_function_const<cv>>{});
        CT_ASSERT(std::is_same<cvl, ct::add_function_const<vl>>{});
        CT_ASSERT(std::is_same<cvl, ct::add_function_const<cvl>>{});
        CT_ASSERT(std::is_same<cvr, ct::add_function_const<vr>>{});
        CT_ASSERT(std::is_same<cvr, ct::add_function_const<cvr>>{});
    }
