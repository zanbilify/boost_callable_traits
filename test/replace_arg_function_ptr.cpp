...
int main() {

    {
        ...
        using test = ct::replace_arg<0, f, int, char>;
    ...
    {
        using f = sig<N<0>, N<1>, N<2>, N<3>, N<4>>;
        using test = ct::replace_arg<1, f, int, char>;
    ...
    {
        using f = sig<N<0>, N<1>, N<2>, N<3>, N<4>>;
        using test = ct::replace_arg<2, f, int, char>;
    ...
    {
        using f = sig<N<0>, N<1>, N<2>, N<3>, N<4>>;
        using test = ct::replace_arg<3, f, int, char>;
    ...
    {
        using f = sig<N<0>, N<1>, N<2>, N<3>, N<4>>;
        using test = ct::replace_arg<4, f, int, char, short, void*>;
