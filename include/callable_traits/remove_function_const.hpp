...
namespace callable_traits {
    ...
    namespace permissive {
        ...
        template<typename T>
        using remove_function_const = detail::fallback_if_invalid<
    ...
    namespace verbose {
        ...
        template<typename T>
        using remove_function_const = detail::fail_if_invalid<
            typename detail::traits<T>::remove_function_const,
            detail::remove_function_const_error<false>>;
    }

    template<typename T>
    using remove_function_const = detail::fail_if_invalid<
            typename detail::traits<T>::remove_function_const,
            detail::remove_function_const_error<true>>;
}
