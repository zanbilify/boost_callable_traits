...
template<typename Return, typename T, typename... Args>
struct pmf<Return(CALLABLE_TRAITS_CC T::*)(Args...) CALLABLE_TRAITS_INCLUDE_QUALIFIERS>
    ...
    using apply_member_pointer =
        Return(CALLABLE_TRAITS_CC U::*)(Args...) CALLABLE_TRAITS_INCLUDE_QUALIFIERS;
        
    template<typename NewReturn>
    using apply_return =
        NewReturn(CALLABLE_TRAITS_CC T::*)(Args...) CALLABLE_TRAITS_INCLUDE_QUALIFIERS;
