...
#define CALLABLE_TRAITS_IX_SEQ(...) ::callable_traits::detail::polyfills::index_sequence<__VA_ARGS__>

#undef CALLABLE_TRAITS_MAKE_IX_SEQ
#define CALLABLE_TRAITS_MAKE_IX_SEQ(...) ::callable_traits::detail::polyfills::make_index_sequence<__VA_ARGS__>
