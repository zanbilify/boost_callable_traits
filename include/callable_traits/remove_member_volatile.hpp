...
namespace callable_traits {
    ...
    namespace detail {
        ...
        struct remove_member_volatile_error {
    ...
    namespace permissive {
        ...
        template<typename T>
        using remove_member_volatile = detail::fallback_if_invalid<
    ...
    namespace verbose {
        ...
        template<typename T>
        using remove_member_volatile = detail::fail_if_invalid<
            typename detail::traits<T>::remove_member_volatile,
            detail::remove_member_volatile_error<false>>;
    }
