...
namespace callable_traits {
    ...
    namespace verbose {
        ...
        template<typename T>
        using remove_const_qualifier =
            detail::remove_const_qualifier_t<T, false>;
    }

    template<typename T>
    using remove_const_qualifier =
        detail::remove_const_qualifier_t<T, true>;
}
