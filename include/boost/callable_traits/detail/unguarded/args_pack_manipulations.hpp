...
struct insert_impl<BOOST_CLBL_TRTS_IX_SEQ(I...), std::tuple<U...>, StartTo> {

    using type = sfinae_try<
        BOOST_CLBL_TRTS_BEGIN_PACK_MANIP
        typename std::tuple_element<
            map_insert<I, arg_count, StartTo, sizeof...(U)>::value,
            std::tuple<BOOST_CLBL_TRTS_ARGS_PACK..., U...>>::type...
...
template<std::size_t... I, typename... U, std::size_t StartTo>
struct overwrite_impl<BOOST_CLBL_TRTS_IX_SEQ(I...), std::tuple<U...>, StartTo> {
