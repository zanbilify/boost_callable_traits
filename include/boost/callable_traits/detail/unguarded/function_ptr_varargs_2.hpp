...
template<typename Return, typename... Args BOOST_CLBL_TRTS_NOEXCEPT_TEMPL>
struct function<BOOST_CLBL_TRTS_ST Return(BOOST_CLBL_TRTS_VARARGS_CC *)(Args..., ...)
 ...
 : default_callable_traits<> {
    ...
    using clear_args =
        BOOST_CLBL_TRTS_ST Return(BOOST_CLBL_TRTS_VARARGS_CC *)()
            BOOST_CLBL_TRTS_INCLUDE_TRANSACTION_SAFE
            BOOST_CLBL_TRTS_NOEXCEPT_SPEC;
...
#define BOOST_CLBL_TRTS_BEGIN_PACK_MANIP Return(BOOST_CLBL_TRTS_VARARGS_CC *)(
